...
<body class="lw-outer-home-page">
    ...
    <body id="page-top">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                        <div class="card text-center border-0 p-5">
                            ...
                            <p>{{ __tr("Connect directly with your customers in real-time on WhatsApp using __appName__ intuitive interface and seamless integration. Build lasting relationships that drive results.", [
                                '__appName__' => $appName
                            ]) }}
                            </p>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                        <div class="card text-center border-0 p-5">
                            ...
                            <p>{{ __tr("With __appName__ every chat is an opportunity. Transform casual chats into meaningful interactions that lead to increased conversions through targeted messaging and personalized campaigns.", [
                                '__appName__' => $appName
                            ]) }}
                            </p>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
                        <div class="card text-center border-0 p-5">
                            ...
                            <p> {{ __tr("Your customers deserve the best support, and __appName__ delivers with 24/7 automated responses that ensure you never miss a beat. Stay connected, stay responsive, and watch your business thrive.", [
                                '__appName__' => $appName
                            ]) }}
                            </p>
                        </div>
                ...
                <div class="row px-2">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 co-xl-4 mb-4">
                        <div class="card border-0 p-5 h-100 ">
                            ...
                            <p> {{ __tr( "__appName__ chat feature replicates the native WhatsApp interface, guaranteeing users a seamless and familiar messaging experience.", [
                                '__appName__' => $appName
                            ]) }}
                            </p>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 co-xl-4 mb-4">
                        <div class="card border-0 p-5 h-100 ">
                            ...
                            <p>{{ __tr('__appName__ Advanced interactive bots now provide smarter, more engaging replies, supporting images, documents, videos, audios and interactive buttons for enhanced user interaction.', ['__appName__' => $appName]) }}
                            </p>
                        </div>
                    </div>
                    <!-- /Interactive/Button Messages for bot reply -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 co-xl-4 mb-4">
                        <div class="card border-0 p-5 h-100 ">
                            ...
                            <p>{{ __tr('Personalize your messages with user base information and custom fields tailored to your audience on __appName__', ['__appName__' => $appName]) }}
                            </p>
                        </div>
                    </div>
                    {{-- /Custom Fields --}}
        ...
        <section class="lw-bg-success text-white text-center p-5">
            <h2 class="ubuntu-bold"> {{ __tr('Make Connecting Easy with') }}<span class="text-warning">{{  $appName }}</span></h2>
            ...
            <div class="container">
                <div class="row align-items-center p-3 mb-4">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        ...
                        <p>{{ __tr('__appName__ is a helpful tool for businesses to communicate better with customers. It makes talking to customers easier and simpler, helping businesses grow and build strong relationships.', ['__appName__' => $appName]) }}
                        </p>
                        <div class="lw-button">
        ...
        <!-- Basic features section -->
        <!-- pricing block -->
        <section class="lw-bg-dark bg-dark lw-pricing-block" id="pricing">
            <div class="container">
                <!-- heading -->
                        ...
                        <div class="card border-0 text-center text-dark p-4 h-100">
                            ...
                            <ul>
                                ...
                                <li>
									...
									@if($featureKey=="system_users")
									<li>
										<strong>@php echo $featureValue['limit']*100; @endphp</strong> Responses AI (Text/Image/Audio Per Month)
									</li>
									@endif
                                @endforeach
                            </ul>
