<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white lw-sidebar-container" id="sidenav-main">
    ...
    <a class="navbar-brand pt-0 d-none d-sm-inline" href="{{ url('/') }}">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
			...
			<li class="nav-item">
				<!-- Ítem de Forms que abre el modal -->
				<a href="#" class="nav-link" data-toggle="modal" data-target="#customFormsModal">
