<div class="row">
    ...
    {{-- Automate AI - Alfa Business Apps --}}
        <div class="col-md-8" x-cloak>
        <!-- Page Heading -->
        <fieldset x-data="{panelOpened:false}" x-cloak>
            <legend @click="panelOpened = !panelOpened"><img class="p-2 mr-3" style="background-color: white" width="150" src="https://ai.alfabusiness.app/upload/images/logo/Dnlt-dashboard-ai-alfa-business-logo.png" alt="{{ __tr('AlfaAgentAI') }}"><?= __tr('AlfaAgent AI') ?> <small class="text-muted">{{  __tr('Click to expand/collapse') }}</small></legend>
            ...
            <p>
                ...
                <div>
<img class="p-2 mr-3" style="background-color: black" width="150" src="{{ asset('imgs/flowise-ai-logo.png') }}" alt="{{ __tr('AlfaAgentAI') }}">
