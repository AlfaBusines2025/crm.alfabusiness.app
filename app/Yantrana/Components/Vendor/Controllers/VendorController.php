...
class VendorController extends BaseController
{
    ...
    *---------------------------------------------------------------- */
	...
	public function privacyPolicy($vendorUID)
    {
        ...
        // Preparar los datos. Si no existen en el registro, se muestran placeholders.
        $data = [
            ...
            'select_country'        => $vendor->select_country ?? '{Select Country}',
            'business_phone'        => $vendor->business_phone ?? '{Business Phone}',
            'contact_email'         => $vendor->contact_email ?? '{Contact Email}',
            'other'                 => $vendor->other ?? '{Other}',
        ];

        // Retornar la vista 'privacy' pasándole los datos
    ...
    {
        // Buscar el vendor por el campo _uid
        $vendor = VendorModel::where('_uid', $vendorUID)->first();
        ...
        // Preparar los datos a usar en la vista
        $data = [
            'vendor_title'         => $vendor->title ?? '{Vendor Title}',
            'business_information' => $vendor->business_information ?? '{Business Information}',
            'address_and_contact'  => $vendor->address_and_contact ?? '{Address & Contact}',
